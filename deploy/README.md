...
Текущие pin’ы `deploy.sh`: hub **v3.0.6**, UI **v3.0.17**, cm **v3.0.2**, video-recorder **`qaguru/video-recorder:latest`**. См. [RELEASE_v3.0.17-ui.md](RELEASE_v3.0.17-ui.md) · [RELEASE_v3.0.6.md](RELEASE_v3.0.6.md) · [RELEASE_v3.0.15-ui.md](RELEASE_v3.0.15-ui.md) (prior UI TS cut) · [RELEASE_v3.0.5.md](RELEASE_v3.0.5.md) (hub/cm Go module paths).
...
Pin версии (опционально; default hub **v3.0.6**, UI **v3.0.17**, cm **v3.0.2**):

```bash
SELENOID_VERSION=v3.0.6 SELENOID_UI_VERSION=v3.0.17 CM_VERSION=v3.0.2 ./deploy/deploy.sh
```
