...
Текущие pin’ы `deploy.sh`: hub **v3.0.9**, UI **v3.0.29**, cm **v3.0.2**, video-recorder **`qaguru/video-recorder:latest`**. См. [RELEASE_v3.0.9.md](RELEASE_v3.0.9.md) · [RELEASE_v3.0.29-ui.md](RELEASE_v3.0.29-ui.md) · [RELEASE_v3.0.8.md](RELEASE_v3.0.8.md).
...
Pin версии (опционально; default hub **v3.0.9**, UI **v3.0.29**, cm **v3.0.2**):

```bash
SELENOID_VERSION=v3.0.9 SELENOID_UI_VERSION=v3.0.29 CM_VERSION=v3.0.2 ./deploy/deploy.sh
```
