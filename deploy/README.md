...
Текущие pin’ы `deploy.sh`: hub **v3.0.5**, UI **v3.0.14**, cm **v3.0.2**, video-recorder **`qaguru/video-recorder:latest`**. См. [RELEASE_v3.0.5.md](RELEASE_v3.0.5.md) (qa-guru Go module paths).
...
Pin версии (опционально; default hub **v3.0.5**, UI **v3.0.14**, cm **v3.0.2**):

```bash
SELENOID_VERSION=v3.0.5 SELENOID_UI_VERSION=v3.0.14 CM_VERSION=v3.0.2 ./deploy/deploy.sh
```
