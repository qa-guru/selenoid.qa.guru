...
Текущие pin’ы `deploy.sh`: hub **v3.0.13**, UI **v3.0.43**, cm **v3.0.3**, video-recorder **`qaguru/video-recorder:latest`**. Warm **4/4** / hot **2/2** on box1 orchestrator. См. [RELEASE_v3.0.43.md](RELEASE_v3.0.43.md) · [hub v3.0.13](https://github.com/qa-guru/selenoid/releases/tag/v3.0.13) · [UI v3.0.43](https://github.com/qa-guru/selenoid-ui/releases/tag/v3.0.43) · [cm v3.0.3](https://github.com/qa-guru/cm/releases/tag/v3.0.3).
...
Pin версии (опционально; default hub **v3.0.13**, UI **v3.0.43**, cm **v3.0.3**):

```bash
SELENOID_VERSION=v3.0.13 SELENOID_UI_VERSION=v3.0.43 CM_VERSION=v3.0.3 ./deploy/deploy.sh
```
